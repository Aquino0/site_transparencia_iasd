        ...
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 transition-colors duration-300">
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                        <h1 className="text-lg font-bold text-gray-900 dark:text-white leading-tight">IASD Vila Pinheiro</h1>
                        <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Portal da Transparência</p>
                    </div>
                </div>
