...
export function WhatsappButton() {
    ...
    return (
        <a
            ...
            className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white p-3 md:p-4 rounded-full shadow-lg transition-transform hover:scale-110 z-50 flex items-center gap-2 group print:hidden"
